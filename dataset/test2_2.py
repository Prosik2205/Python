...
# Шляхи до папок
input_folder = 'C:\\Users\\prosi\\Desktop\\VNS Data\\1 Курс\\2 Семестр\\Соціологія Та Психологія\\PDF'  # Папка з PDF файлами
output_folder = 'C:\\Users\\prosi\\Desktop\\json\\Соціологія і Психологія'  # Папка для збереження JSON файлів
