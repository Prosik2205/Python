...
# Шляхи до папок
input_folder = 'C:\\Users\\prosi\\Desktop\\VNS Data\\1 Курс\\1 Семестр\\Лінійна алгебра та аналітична геометрія\\PDF'  # Папка з PDF файлами
output_folder = 'C:\\Users\\prosi\\Desktop\\json\\ЛААГ'  # Папка для збереження JSON файлів
